...
<body class="bg-gray-200">
  <main class="main-content mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('https://images.unsplash.com/photo-1497294815431-9365093b7331?auto=format&fit=crop&w=1950&q=80');">
      <span class="masFk bg-gradient-dark opacity-6"></span>
              ...
              <div class="card-body">
                <form role="form" method="POST" action="${pageContext.request.contextPath}/AuthServlet">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="${pageContext.request.contextPath}/Client/views/Sign_up.jsp" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </form>
              </div>
            </div>
  ...
  <!-- Core JS Files -->
  <script src="${pageContext.request.contextPath}/Client/assets/js/core/popper.min.js"></script>
  <script src="${pageContext.request.contextPath}/Client/assets/js/core/bootstrap.min.js"></script>
  <script src="${pageContext.request.contextPath}/Client/assets/js/material-dashboard.min.js?v=3.2.0"></script>
</body>
