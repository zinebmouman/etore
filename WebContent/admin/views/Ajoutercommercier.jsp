...
<head>
    ...
    <title>Ajouter un Nouveau Commerce</title>
    <!-- Fonts and icons -->
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container mt-5">
            <h4 class="font-weight-bolder">Ajouter un Nouveau Commerce</h4>
            <form action="${pageContext.request.contextPath}/Gerercommercier?action=add" method="post">
                <!-- Nom du commerce -->
                ...
                <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" class="form-control" id="type_commerce" name="type_commerce"  required>
                </div>
