                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Type de Commerce</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="${pageContext.request.contextPath}/admin/assets/img/default-avatar.png" class="avatar avatar-sm me-3 border-radius-lg" alt="commerce-avatar">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"><c:out value="${commerce.nom}" /></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><c:out value="${commerce.adresse}" /></td>
                                                <td class="align-middle text-center"><c:out value="${commerce.contact}" /></td>
                                                <td class="align-middle text-center"><c:out value="${commerce.type_commerce}" /></td>
                                                <td class="align-middle">
                                                    <a href="${pageContext.request.contextPath}/Gerercommercier?action=edit&id=${commerce.id_commerce}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Edit user">
                                                        Modifier
                                                    </a>
                                                </td>
                                               <td class="align-middle">
