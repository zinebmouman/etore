...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container mt-5">
            <h4 class="font-weight-bolder">Ajouter un Nouveau Produit</h4>
            <form action="${pageContext.request.contextPath}/GererProduit?action=insert&id_commerce=${id_commerce}" method="post">
                <!-- Nom du produit -->
